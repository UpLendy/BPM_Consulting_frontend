...
export default function Header({ 
  ...
  return (
    <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 sm:px-6 shadow-sm z-30 relative">
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <div className="relative hidden md:block">
          ...
          <input
            ...
            className="pl-10 pr-4 py-2 w-48 lg:w-80 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-medium"
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        <div className="relative" ref={notifRef}>
            ...
            {showNotifications && (
                <div className="fixed sm:absolute top-16 sm:top-auto right-4 sm:right-0 mt-2 sm:mt-3 w-[calc(100vw-2rem)] sm:w-96 bg-white rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] border border-gray-100 py-0 z-50 overflow-hidden ring-1 ring-black/5 animate-in fade-in zoom-in duration-200">
